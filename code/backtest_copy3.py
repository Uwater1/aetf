...
def load_market_data():
    ...
    csi300['csi300_ema20'] = ta.ema(csi300['csi300_close'], length=20)
    ...
    # Require price to be below both EMA60 and EMA20 for a weak market.
    # This places more emphasis on recent data, exiting weak market earlier if momentum turns positive.
    market['weak_market'] = (
        (market['csi300_close'] < market['csi300_ema60']) &
        (market['csi300_close'] < market['csi300_ema20'])
    )
    # Extreme weak market
